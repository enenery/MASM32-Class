...
.data			 
      	...
      	array1 byte 1,' ',4,'x' ,2,' ',4,'x',1,' '  
	array2 byte 1,' ',1,'x' ,2,' ',1,'x',2,' ',1,'x',1,' ' 
	array3 byte 1,' ',4,'x' ,2,' ',4,'x',1,' ' 
	array4 byte 1,' ',1,'x' ,2,' ',1,'x',5,' ',1,'x',1,' ' 
	array5 byte 1,' ',1,'x' ,2,' ',1,'x',2,' ',4,'x',1,' ' 
	array6 byte 1,' ', 4,' ', 2,' ', 4, ' ',1,' '        
                      xstart byte 3
                     ystart byte 12
